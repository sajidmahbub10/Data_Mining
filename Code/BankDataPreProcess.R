...
data<- rename(data, "Class"=target)
write.csv(data, file = "D:/11th Semester/honk.csv", row.names = FALSE)


train<- rename(train, "target_col"=Class)
...
train$target_col <- as.character(train$target_col)
